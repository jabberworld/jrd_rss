...
* Так как на сейчас в транспорте есть поиск и выборка последних новостей, то колонка datetime в таблице sent перестала быть простым маркером аткуальности контента, как это было поначалу. В итоге логика сортировки и выборки данных ломалась. В этом релизе это исправлено: добавлена еще одна колонка, где хранится время занесения новости в таблицу sent. Также убрана давно уже неиспользуемая колонка received. Обновите схему базы - см. каталог alts.
