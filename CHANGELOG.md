...
* Теперь в конфигурационном файле можно задать размер архива сообщений, размер должен находиться в диапазоне от 3 до 30 дней. Также добавлены алиасы для команд поиска, появившихся в прошлой версии - ? и ?!.
